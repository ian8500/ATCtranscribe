...
export default function TranscriptEditor() {
  ...
  useEffect(() => {
    ...
    apiFetch<Line[]>(`/api/transcripts/${transcriptId}/lines`).then(setLines).catch(() => setLines([]));
    apiFetch<Label[]>(`/api/transcripts/${transcriptId}/labels`).then(setLabels).catch(() => setLabels([]));
  }, [transcriptId]);
